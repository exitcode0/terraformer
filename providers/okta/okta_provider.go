...
func (p *OktaProvider) GetSupportedService() map[string]terraformutils.ServiceGenerator {
	return map[string]terraformutils.ServiceGenerator{
		...
		"okta_app_oauth_api_scope":              &AppOAuthAPIScopeGenerator{},
		"okta_app_oauth_role_assignment":        &AppOAuthRoleAssignmentGenerator{},
		"okta_app_signon_policy":                &AppSignOnPolicyGenerator{},
		"okta_app_signon_policy_rule":           &AppSignOnPolicyRuleGenerator{},
		"okta_app_group_assignments":            &AppGroupAssignmentsGenerator{},
		"okta_app_user_base_schema_property":    &AppUserBaseSchemaPropertyGenerator{},
		...
		"okta_group_role":                       &GroupRoleGenerator{},
		"okta_group_owner":                      &GroupOwnerGenerator{},
		"okta_group_memberships":                &GroupMembershipsGenerator{},
		"okta_group_schema_property":            &GroupSchemaPropertyGenerator{},
		...
		"okta_policy_device_assurance_windows":  &PolicyDeviceAssuranceWindowsGenerator{},
		"okta_policy_device_assurance_macos":    &PolicyDeviceAssuranceMacOSGenerator{},
		"okta_policy_device_assurance_ios":      &PolicyDeviceAssuranceIOSGenerator{},
		"okta_policy_device_assurance_android":  &PolicyDeviceAssuranceAndroidGenerator{},
		"okta_policy_device_assurance_chromeos": &PolicyDeviceAssuranceChromeOSGenerator{},
		...
		"okta_resource_set":                     &ResourceSetGenerator{},
		"okta_profile_mapping":                  &ProfileMappingGenerator{},
		"okta_admin_role_custom":                &AdminRoleCustomGenerator{},
		"okta_admin_role_custom_assignments":    &AdminRoleCustomAssignmentsGenerator{},
		"okta_request_condition":                &RequestConditionGenerator{},
	}
}
